<template>
  <main class="container-narrow relative">
    ...
    <div class="relative z-10 flex flex-col gap-2 items-center pt-120">
      ...
      <div class="flex items-center gap-4">
        ...
        <UiButton size="lg" variant="ghost" class="z-10 w-fit">
          See our work
        </UiButton>
      </div>
  ...
  <section class="container-narrow container-section">
      ...
      <ul class="flex flex-1 flex-col gap-6">
        <li>
          ...
          <p class="text-sm text-muted-foreground mt-0.5">
            Get up and running in days, not months. We handle the infrastructure
        ...
        <li>
          ...
          <p class="text-sm text-muted-foreground mt-0.5">
            Your data stays yours. Every integration is built with security and
            privacy at its core.
          </p>
        </li>
        <li>
          <h3>Training & 24/7 support</h3>
          <p class="text-sm text-muted-foreground mt-0.5">
            We teach you and your team to get the most out of AI and stay
            available around the clock when you need us.
          </p>
        </li>
      </ul>
    </div>
